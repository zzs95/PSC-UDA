import torch
from common.utils.metric_logger import AverageMeter
...
class SegAccuracy(AverageMeter):
    ...
    def update_dict(self, preds, labels):
        ...
        seg_label = labels['edge_label']  # (b, n)
...
class SegIoU(object):
    ...
    def update_dict(self, batch_dict):
        seg_logit = batch_dict['logits']  # (batch_size, num_classes, num_points)
        seg_label = batch_dict['edge_label']  # (batch_size, num_points)
        pred_label = seg_logit.argmax(1)
